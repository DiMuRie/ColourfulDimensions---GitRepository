...
public class Block000x extends Block {
	
	public static final PropertyInteger NUMBER = PropertyInteger.create("numberzzzx", 0, 9);
	
	public Block000x(){
		super(Material.ROCK);
		setCreativeTab(ColourfulItems.cpTab);
		setUnlocalizedName("x000");
		setRegistryName("x000");
		setBlockUnbreakable();
