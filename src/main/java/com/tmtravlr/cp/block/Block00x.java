...
public class Block00x extends Block {
	
	public static final PropertyInteger NUMBER = PropertyInteger.create("numberzzx", 0, 9);
	
	public Block00x(){
		super(Material.ROCK);
		setCreativeTab(ColourfulItems.cpTab);
		setUnlocalizedName("0x00");
		setRegistryName("0x00");
		setBlockUnbreakable();
