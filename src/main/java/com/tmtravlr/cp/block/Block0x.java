...
public class Block0x extends Block {
	
	public static final PropertyInteger NUMBER = PropertyInteger.create("numberzx", 0, 9);
	
	public Block0x(){
		super(Material.ROCK);
		setCreativeTab(ColourfulItems.cpTab);
		setUnlocalizedName("00x0");
		setRegistryName("00x0");
		setBlockUnbreakable();
